...
type FoodScreenNavigationProp = NativeStackNavigationProp<RootStackParamList, 'Category/Groceries'>;
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.expenseItem}>
            <MaterialIcons name="local-grocery-store" size={24} color="#00C9A7" />
